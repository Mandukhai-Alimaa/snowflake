...
def _snowflake_query(path: Path) -> str:
    ...
    quoted_sql = re.sub(create_table_pattern, quote_create_table_columns, quoted_sql, flags=re.DOTALL | re.IGNORECASE)
    ...
    quoted_sql = re.sub(insert_pattern, quote_insert_columns, quoted_sql, flags=re.IGNORECASE)
